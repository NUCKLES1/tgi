...
const Flexible = () => {
  ...
  const facts = [
    {
      number: "01",
      question: "Quick ramp-up time",
      answer: "With on-demand team availability and required domain knowledge",
    },
    {
      number: "02",
        ...
        <div className="">
          {facts.map((facts, index) => {
            return (
              <div
                key={index}
                className="border-t border-b py-8 border-[#c0bbbb] text-gray-700"
              >
                <div className="w-full flex">
                  ...
                  <div className="lg:pl-4">
                    <p className="text-gray-700 mt-2 max-sm:w-[80%]  lg:text-3xl flex max-sm:text-xl uppercase">
                      <IoArrowForwardOutline className="w-20 max-sm:text-2xl mt-[5px] " />{" "}
                      {facts.question}
                    </p>
                    <p className="pl-20 mt-2">{facts.answer}</p>
                  </div>
                </div>
              </div>
            );
