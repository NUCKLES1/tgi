  ...
  return (
    <div className="pb-20 h-auto bg-yellow-200 w-full max-sm:px-6 px-20 py-20">
      <div className="flex flex-col gap-10">
        ...
        <div className="pb-20">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 w-full max-sm:gap-10  lg:border-r lg:border-gray-700">
          <div className="lg:border-l max-sm:border-t max-sm:pt-8 border-gray-600 px-10 md:px-2 md:border-l">
