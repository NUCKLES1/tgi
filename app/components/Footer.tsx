...
const Footer = () => {
  return (
    <div className="-mt-20 w-full overflow-hidden">
      ...
      <div className="w-full h-100 bg-[#232020] pt-10 px-20 max-sm:px-6 max-sm:h-auto pb-10">
        <div className="border-t border-b border-gray-600  w-full py-10">
          <div className="lg:flex w-full justify-between">
            <div>
              <h1 className="text-[15rem] max-sm:text-[10rem] leading-50 font-bold text-gray-500">
                TGI
              </h1>
            </div>
            <div className="text-white w-100 text-left uppercase flex flex-col max-sm:gap-5 gap-26 max-sm:pt-6">
              <div className="flex">
                <IoArrowForwardOutline className="w-10 max-sm:text-3xl lg:mt-2" />
